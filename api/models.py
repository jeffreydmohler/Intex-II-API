...
class Campaign(models.Model):
    ...
    location_state = models.TextField(default='default')
    current_amount_USD = models.TextField(default='default')
    goal_USD = models.TextField(default='default')
    percent_of_goal = models.TextField(default='default')
    amount_per_donation = models.TextField(default='default')
    percent_of_goal_score = models.TextField(default='default')
    amt_per_donor_score = models.TextField(default='default')
    success_score = models.TextField(default='default')
...
class Donation(models.Model):
    ...
    verified = models.TextField(default='default')
